...
@section('content')
    <div class="row"> <!--begin::Col-->
        ...
        <h2 class="text-red"><marquee behavior="" direction="">Welcome to Admin Dashboard || Hospital Management System</marquee></h2>
    </h1>
                                    ...
                                    <div class="direct-chat-messages"> <!-- Message. Default to the start -->
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix"> <span
                                                ...
                                                class="direct-chat-img" src="/assets/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg end">
                                            <div class="direct-chat-infos clearfix"> <span
                                                ...
                                                class="direct-chat-img" src="/assets/img/user3-128x128.jpg"
                                                alt="message user image"> <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
