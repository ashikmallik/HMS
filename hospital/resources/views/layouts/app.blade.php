...
<head>
    ...
    <title>@yield('title', 'Hospital ')</title><!--begin::Accessibility Meta Tags-->
...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary"> <!--begin::App Wrapper-->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // e.g., from ".{{ asset('./css/adminlte.css')}}", we get "../"
            // e.g., from "{{ asset('./css/adminlte.css')}}", we get "./"
    ...
    </script> <!-- OPTIONAL SCRIPTS --> <!-- sortablejs -->
    <script src="https://cdn.jsdelivr.net/npm/sortablejs@1.15.0/Sortable.min.js" crossorigin="anonymous"></script> <!-- sortablejs -->
    <script>
